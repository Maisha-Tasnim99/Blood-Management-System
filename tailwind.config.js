    ...
    extend: {
      ...
      backgroundColor: {
        ...
        gray: {
          ...
          l1a5: 'var(--gray-layer-1-alpha-5)',
          l1a6: 'var(--gray-layer-1-alpha-6)',
          ...
          l2a5: 'var(--gray-layer-2-alpha-5)',
          l2a6: 'var(--gray-layer-2-alpha-6)',
      ...
      gray: {
        ...
        l2a3: 'var(--gray-layer-2-alpha-3)',
        l2a4: 'var(--gray-layer-2-alpha-4)',
        l2a5: 'var(--gray-layer-1-alpha-5)',
        l2a6: 'var(--gray-layer-1-alpha-6)',
      ...
      fontFamily: {
        ...
        'cursive-bangla': ['Atma', 'cursive'],
        'handwriting': ['Indie Flower', 'cursive'],
        
        // Use 'Source Sans Pro' to write any language's regular writing.
        // 'lobster-two' in italic format looks better.  



        // The following two class name has been depricated in version 2.9, but keeping them for supporting old projects.

        'regular': ['Source Sans Pro', 'sans-serif'],
        'regular-space': ['Source Code Pro', 'monospace'],
